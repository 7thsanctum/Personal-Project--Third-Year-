...
bool ParticlesApp::Init()
{
	...
	mSmoke.Init(md3dDevice, Effects::SmokeFX, mFlareTexSRV, mRandomTexSRV, 500000); 
	mSmoke.SetEmitPos(XMFLOAT3(0.0f, 1.0f, 120.0f));

	//mSmoke2.Init(md3dDevice, Effects::SmokeFX, mFlareTexSRV, mRandomTexSRV, 1000000); 
	//mSmoke2.SetEmitPos(XMFLOAT3(-300.0f, 1.0f, -300.0f));
	//mSmoke3.Init(md3dDevice, Effects::SmokeFX, mFlareTexSRV, mRandomTexSRV, 1000000); 
	//mSmoke3.SetEmitPos(XMFLOAT3(300.0f, 1.0f, -300.0f));
